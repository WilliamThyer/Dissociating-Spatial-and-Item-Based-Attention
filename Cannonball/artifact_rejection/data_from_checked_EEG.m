subs = {'01','02','03','04','05','06','07','08','09','10','11','12','13','14','19','20','21','22','23','25','26','27','28','31','33','34','35','36','37'};
experiment = 'C01';
numsubs= length(subs);
root = '.';
...
for isub = 1:numsubs
    ...
    checked_file = ['..\raw_data\',experiment,'\',subs{isub},'\',experiment,'_',subs{isub},'_unchecked.set'];
...
function [artifact_idx] = create_artifact_index(EEG)
    art_idx = logical(EEG.reject.rejmanual)
